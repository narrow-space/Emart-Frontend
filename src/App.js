...
const ListingProductMain = lazy(() => import("./Components/ListingPageMain/ListingProductMain.js"));
const ProductDetails = lazy(() => import("./Components/ProductDetails/ProductDetails.js"));
...
const Dashboard = lazy(() => import("./Components/user_Authentication/Dashboard.js"));
const Myaccount = lazy(() => import("./Components/user_Authentication/Myaccount.js"));
const Orderhistory = lazy(() => import("./Components/user_Authentication/Orderhistory.js"));
const Accountdetails = lazy(() => import("./Components/user_Authentication/Accountdetails.js"));
const Editaddress = lazy(() => import("./Components/user_Authentication/Editaddress.js"));
const Login = lazy(() => import("./Components/user_Authentication/Login.js"));
const Forgotpassword = lazy(() => import("./Components/user_Authentication/Forgotpassword.js"));
const Resetpassword = lazy(() => import("./Components/user_Authentication/Resetpassword.js"));
const Register = lazy(() => import("./Components/user_Authentication/Register.js"));
const Shipping = lazy(() => import("./Components/Shipping/Shipping.js"));
const AdminLogin = lazy(() => import("./Components/Admin_Authentication/AdminLogin.js"));
const AdminRegister = lazy(() => import("./Components/Admin_Authentication/AdminRegister.js"));
const AdminAccount = lazy(() => import("./Components/Admin_Authentication/AdminAccount.js"));
const Admindashboard = lazy(() => import("./Components/Admin_Authentication/Admindashboard.js"));
const AddBannerImages = lazy(() => import("./Components/Admin_Authentication/AddBannerImages.js"));
const Addproducts = lazy(() => import("./Components/Admin_Authentication/Addproducts.js"));
const Addcategories = lazy(() => import("./Components/Admin_Authentication/Addcategories.js"));
const Addbrand = lazy(() => import("./Components/Admin_Authentication/Addbrand.js"));
const Orders = lazy(() => import("./Components/Admin_Authentication/Orders.js"));
const Settings = lazy(() => import("./Components/Admin_Authentication/Settings.js"));
const Adminproducts = lazy(() => import("./Components/Admin_Authentication/Adminproducts.js"));
const UpdateProduct = lazy(() => import("./Components/Admin_Authentication/UpdateProduct.js"));
          ...
          {token ? null : (
            ...
            <Routes>
              ...
              <Route path="adminaccount" element={<AdminProtectedRoutes Components={AdminAccount} />}>
                ...
                <Route exact={true} path="bannerimages" element={<AddBannerImages />} />
                <Route exact={true} path="addproducts" element={<Addproducts />} />
                <Route exact={true} path="updateproduct/:id" element={<UpdateProduct />} />
                <Route exact={true} path="addcategories" element={<Addcategories />} />
                <Route exact={true} path="addbrand" element={<Addbrand />} />
                <Route exact={true} path="orders" element={<Orders />} />
                <Route exact={true} path="settings" element={<Settings />} />
                <Route exact={true} path="products" element={<Adminproducts />} />
              </Route>

              {/* User Router */}
              <Route exact={true} path="/" element={<Layout><Home /></Layout>} />
              <Route exact={true} path="/products-filter" element={<Layout><ListingProductMain /></Layout>} />
              <Route exact={true} path="/allproduct/:id" element={<Layout><ProductDetails /></Layout>} />
              <Route exact={true} path="/viewcart" element={<Layout><Viewcart /></Layout>} />
              <Route exact={true} path="/viewcart/checkout" element={<Layout><Checkout /></Layout>} />
              <Route exact={true} path="/wishlist" element={<Layout><WishList /></Layout>} />
